...
class StarterVCGeneral: UIViewController,UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //お天気APIから東京の天気を取得する
        let url:String = "https://jirozon.herokuapp.com/starter/list?selector=general"
